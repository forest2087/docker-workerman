...
RUN DEBIAN_FRONTEND="noninteractive" apt-get install -y --force-yes php5-cli php5-fpm php5-mysql php5-pgsql php5-sqlite php5-curl\
		       php5-gd php5-mcrypt php5-intl php5-imap php5-tidy php-pear php5-dev git gcc libevent-dev php5-mongo
...
# Install workerman dependencies
RUN DEBIAN_FRONTEND="noninteractive" pecl install channel://pecl.php.net/libevent-0.1.0
